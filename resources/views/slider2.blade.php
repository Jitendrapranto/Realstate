...
<body>
    ...
    <section class="min-h-screen flex space-x-4 items-center justify-center gap-4 lg:gap-0 my-4 lg:my-0">
        <div class="container mx-auto px-4 h-full">
            <div class="flex flex-col lg:flex-row items-center lg:items-stretch justify-between gap-8 w-full h-full">
                <div class="lg:self-start w-full lg:w-[25%] lg:max-w-[25%] h-full">
                ...
                <div class="w-[50%]">
                    <img src="/assets/images/nature.jpg" alt="জলজোছনা"
                        class="rounded-md w-full h-full lg:h-[750px] object-cover">
                </div>
                <div class="lg:self-end w-full lg:w-[25%] lg:max-w-[25%] h-full">
